...
WebUI.click(findTestObject('Object Repository/Page_Selamat Datang di Portal Akademik Univ_c64131/img_view all_img-circle'))

WebUI.click(findTestObject('Object Repository/Page_Selamat Datang di Portal Akademik Univ_c64131/a_Log Out'))
